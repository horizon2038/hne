#ifndef CORE_OPCODE_LDY_HPP
#define CORE_OPCODE_LDY_HPP
...
namespace core
{
    class opcode_ldy final : public opcode
    {
      public:
        opcode_ldy(addressing_mode init_addressing_mode, cpu &target_cpu)

#ifndef CORE_OPCODE_LDA_HPP
#define CORE_OPCODE_LDA_HPP
...
namespace core
{
    class opcode_lda final : public opcode
    {
      public:
        opcode_lda(addressing_mode init_addressing_mode, cpu &target_cpu)
